...
chat_model = ChatGoogleGenerativeAI(model="gemini-2.5-flash-lite", temperature=0.9)
...
# Interactions
response1 = conversational_chain.invoke({"input": "Hello! My name is John. How are you?"}, config=config)
